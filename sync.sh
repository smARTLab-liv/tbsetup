...
wget -q http://swarmlab.dyndns.org/tbsetup/tbsetup/raw-file/tip/get_file.sh
chmod +x get_file.sh
...
then
    ...
    rm set_hostname.sh*
    wget -q http://swarmlab.dyndns.org/tbsetup/tbsetup/raw-file/tip/set_hostname.sh
    wget -q http://swarmlab.dyndns.org/tbsetup/tbsetup/raw-file/tip/macadr-eth1.txt
